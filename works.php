        ...
        <details class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div class="p-4 border-t border-gray-200">
                <form method="GET" id="filter-form-mobile">
                    ...
                    <!-- カテゴリ -->
                    <div class="mb-4">
                        <h4 class="font-medium text-gray-900 mb-2">カテゴリ</h4>
                        <div class="space-y-2">
                    ...
                    <!-- 価格帯 -->
                    <div class="mb-4">
                        <h4 class="font-medium text-gray-900 mb-2">価格帯</h4>
                        <div class="space-y-2">
                            <label class="flex items-center">
                                <input type="radio" name="price_range" value="" 
                                       <?= !$priceMin && !$priceMax ? 'checked' : '' ?>
                                       class="text-blue-600 focus:ring-blue-500 border-gray-300"
                                       onchange="clearPriceInputs(); document.getElementById('filter-form-mobile').submit()">
